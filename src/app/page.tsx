            ...
            <div className="flex flex-col gap-10 px-4 py-10 @container">
              <div className="flex flex-col gap-4 justify-center items-center">
                ...
                <p className="text-[#121516] text-base font-normal leading-normal max-w-[720px]">
                  Your Name Service name is more than just a username. It&apos;s
                  your identity in the decentralized world.
                </p>
              </div>
              <div className="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-0">
                <div className="flex flex-1 gap-3 rounded-lg border border-[#dde1e3] bg-white p-4 flex-col">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-[#6a7681] text-sm font-normal leading-normal">
                      No more copying long addresses. Use your Name Service name
                      to store all of your addresses and receive any
                ...
                <div className="flex flex-1 gap-3 rounded-lg border border-[#dde1e3] bg-white p-4 flex-col">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-[#6a7681] text-sm font-normal leading-normal">
                      Instead of renting a domain name for a yearly fee, you can
                      own your Name Service name with a one-time registration
                      fee.
                    </p>
                  </div>
                </div>
